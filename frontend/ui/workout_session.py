# =========================================
# workout_session.py  ✅ MODIFIED (Tutorial -> WorkoutDemo)
# =========================================
"""
Workout Session UI with live camera feedback and guided workflow.
Matches the provided reference design.
✅ Demo video is ALWAYS muted
✅ Tutorial button opens WorkoutDemo screen
"""
...
class WorkoutSession(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.demo_audio.setVolume(0.0)  # ✅ Always silent
    ...
    def init_ui(self):
        ...
        """)
        self.tutorial_btn.clicked.connect(self.open_tutorial)  # ✅ NEW
