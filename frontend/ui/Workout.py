...
✅ Logout button is on the SAME LINE as Name + Plan
✅ NO rectangle/shape behind Trainee + Plan text (hard override)
✅ RIGHT half has MOST PRIORITY
✅ LEFT half is visible but lower priority
✅ FIX 1: Remove small boxes behind workout names/values
"""
